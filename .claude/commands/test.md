...
1. **Python Syntax Check**
   ...
   - Command: `uv run python -m compileall orchestrator/ adws/`
...
2. **Backend Code Quality Check**
   - Preparation Command: None
   - Command: `uv run ruff check orchestrator/ adws/`
...
4. **TypeScript Type Check**
   - Preparation Command: None
   - Command: `cd dashboard/client && bun tsc --noEmit`
...
5. **Frontend Build**
   - Preparation Command: None
   - Command: `cd dashboard/client && bun run build`
...
[
  {
    "test_name": "frontend_build",
    "passed": false,
    "execution_command": "cd dashboard/client && bun run build",
  ...
  },
  {
    "test_name": "all_backend_tests",
    "passed": true,
    "execution_command": "uv run pytest adws/adw_tests/ -v --tb=short",
    "test_purpose": "Validates all backend functionality including file processing, SQL security, LLM integration, and API endpoints"
  }
]
```